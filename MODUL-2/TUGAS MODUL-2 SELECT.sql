-- Untuk menghapus sebuah database bernama aplikasi_gojek, jika database tersebut sudah ada
DROP DATABASE IF EXISTS aplikasi_gojek;

-- Untuk membuat database
CREATE DATABASE aplikasi_gojek;

-- Untuk mengaktifkan database aplikasi_gojek
USE aplikasi_gojek;
...
SELECT aplikasi_gojek.driver.Nama FROM driver;
...
CREATE TABLE Rating (
    ...
    NIK_pengguna VARCHAR(20),
    NIK_driver VARCHAR(20),
    Rating INT CHECK (Rating >= 1 AND Rating <= 5), -- untuk membatasi nilai dari rating
...
-- Cek Semua isi Data / mengambil semua data dari tabel yang telah di isi
SELECT * FROM Driver;
